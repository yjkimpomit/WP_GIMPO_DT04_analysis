...
<main class="winbox-layout page-content page-content--popup" id="searchReqDeptTreePopup">
    <h1 class="page-content__heading visually-hidden">요청부서 검색</h1>

    <%--<!-- 트리메뉴 데이터 들어가는 영역 START -->--%>
    <div class="content__placeholder jstree-box">
