...
<%--
검색박스내 감독부서 검색시 열리는 팝업 : 트리박스
/common/modalSearchTreeOversightDept.do
--%>
...
<main class="winbox-layout page-content page-content--popup" id="searchReqTreePopup">
    <h1 class="page-content__heading visually-hidden">감독부서 검색</h1>
