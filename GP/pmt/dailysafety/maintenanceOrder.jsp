                ...
                <form class="filter-panel" id="searchWorkOrderForm" method="post" autocomplete="off">
                    ...
                    <div class="filter-panel__search" id="filter-panel-search">
                        ...
                        <div class="filter-panel__fields">
                            ...
                            <div class="form-field">
                                ...
                                <div class="form-control-group">
                                    ...
                                    <input class="form-control form-control--search" id="designerOption" name="designBy" onclick="searchItemPopup($(this));">
                            ...
                            <div class="form-field">
                                ...
                                <div class="form-control-group">
                                    ...
                                    <input class="form-control form-control--search" id="designDeptOption" name="designDeptNo" onclick="searchdesignDeptTreePopup($(this));">
                            ...
                            <div class="form-control-group">
                                <div class="form-field">
                                    ...
                                    <!-- <%--
                                    <input class="form-control form-control--search" id="constCodeOption" name="projectNo" onclick="searchmainDeptTreePopup($(this));">
                                    --%> -->
                            ...
                            <div class="form-field">
                                ...
                                <div class="form-control-group">
                                    <input class="form-control form-control--search" id="equipNoOption" name="equipNo" onclick="searchFacilityPopup($(this));">
                        ...
                        <div class="filter-panel__actions">
                            ...
                            <button type="button" class="button button--secondary" onclick="javascript: alert('설비분류체계 윈박스 오픈예정');">설비분류체계</button>
                        </div>
                    </div>

                    <%--<section class="filter-panel__section" aria-labelledby="equipment-classification-title">
                        <h2 class="filter-panel__section-title visually-hidden" id="equipment-classification-title">
                            설비분류체계
                        </h2>
                        <!-- &lt;%&ndash; tree list view : 기능위치/계통/종류 &ndash;%&gt; -->
...
<script>
    ...
    function fnSearchWorkOrderList() {
        $.ajax({
            type: "POST"
            , url: "/dailySafety/maintenanceOrderList.do"
    ...
    function fnShowSafetyWorkPermitPop(row) {
        ...
        var data = "?woNo=" + no + "&authoNo=" + aNo + "&workOrderType=" + workOrderType;
        var url = "/dailySafety/routineWorkOrderPermitPop.do" + data;

        var box = new WinBox("안전작업허가서", {
            url: url,
    ...
    function fnExcelDownloadWorkOrder() {
        ...
        $.ajax({
            type: "POST"
            , url: "/dailySafety/workOrderOHExcelDownload.do"
            , data: $("#searchWorkOrderForm").serialize()
            , xhrFields: {
            ...
            , success: function (response, status, xhr) {
                try {
                    ...
                    link.download = "공사오더(OH)_" + formattedDate + ".xlsx";
                    link.click();  // 다운로드 트리거
                } catch (e) {
                    console.log(e);
                    $("#loadingBar").css("display", "none");
