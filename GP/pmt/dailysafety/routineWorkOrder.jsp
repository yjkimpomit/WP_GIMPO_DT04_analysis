		...
		<div class="splitview">
					...
					<div class="filter-panel__search" id="filter-panel-search">
						...
						<div class="filter-panel__fields">
							...
							<div class="form-field">
								...
								<div class="form-control-group">
									<input class="form-control form-control--search" id="maintDeptOption" name="workDeptNo" onclick="searchmainDeptTreePopup($(this));">
			...
			<section class="splitview__pane splitview__pane--content" aria-label="검색 결과">
				<h1 class="page-content__heading">경상오더</h1>
					...
					<%-- data-grid : 결과 리스트 뷰 --%>
					<div class="result-panel" id="_VIEW_RESULT_LIST">
						<%-- 조회결과 리스트 뷰 : /detail/routineWorkOrder_list.jsp --%>
	
					</div>
	
					<%-- 품질안전설계 시작 --%>
					<div class="result-group" id="_VIEW_RESULT_SAFETY_QUALITY">
