	...
	<div class="page-content__placeholder">
		<div class="splitview">
					...
					<div class="filter-panel__search" id="filter-panel-search">
						...
						<div class="filter-panel__fields">
							...
							<div class="form-field">
								...
								<div class="form-control-group">
								<input class="form-control form-control--search" id="issuerOption" name="printBy" onclick="searchItemPopup($(this));">
							...
							<div class="form-field">
								...
								<div class="form-control-group">
								<input class="form-control form-control--search" id="retrieverOption" name="returnBy" onclick="searchItemPopup($(this));">
							...
							<div class="form-field">
								...
								<div class="form-control-group">
								<input class="form-control form-control--search" id="opDeptOption" name="operDeptNo" onclick="searchopDeptTreePopup($(this));">
			...
			<section class="splitview__pane splitview__pane--content" aria-label="검색 결과">
				...
				<%-- data-grid : 결과 리스트 뷰 --%>
				<div class="result-panel" id="manageList">
