	...
	<div class="result-header">
		...
		<div class="result-header__actions">
			<nav class="pagination" aria-label="페이지 이동">
				...
				<button type="button" class="button button--neutral" onclick="fnPageMovePopUnregist('M')">이동</button>
				<button type="button" class="button button--neutral" onclick="fnPageMovePopUnregist('P')">이전</button>
				<button type="button" class="button button--neutral" onclick="fnPageMovePopUnregist('N')">다음</button>
			</nav>
		</div>
	</div>
</form>
