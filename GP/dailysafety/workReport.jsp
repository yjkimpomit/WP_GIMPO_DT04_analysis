...
<main class="winbox-layout page-content daily-status-page">
	...
	<section class="daily-status-section">
		...
		<div class="daily-summary-grid">
			<section class="daily-summary-card">
				<h3 class="daily-summary-card__title">작업현황</h3>
	...
	<section class="daily-status-section">
		...
		<div class="daily-summary-grid">
			<section class="daily-summary-card">
				<h3 class="daily-summary-card__title">인력현황</h3>
				<div class="table-responsive">
	...
	<section class="daily-status-section">
		...
		<div class="daily-summary-grid">
			<section class="daily-summary-card">
				<h3 class="daily-summary-card__title">전체작업</h3>
				<div class="table-responsive">
	...
	<section class="daily-status-section">
		...
		<div class="daily-summary-grid">
			<section class="daily-summary-card">
				<h3 class="daily-summary-card__title">등록현황</h3>
				<div class="table-responsive">
