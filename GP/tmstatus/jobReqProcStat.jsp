...
<div class="title-box">
    <h3 class="title02">작업요청 처리현황</h3>
</div>

<div class="search-box">
    <form id="form_search_job_req_proc" method="post" autocomplete="off">
        <div class="row">
        	<!-- 사업소 영역 추후에 사용할 수 있음 -->
            ...
            <fieldset class="col-md-6 col-lg-4">
                <legend id="confirmedDt" class="form-label">검색기간(확정일)</legend>
            ...
            <fieldset class="col-md-6 col-lg-4 col-xxl-4">
            ...
            <fieldset class="col-md col-lg-4 col-xxl-4">
            ...
            <div class="col-md-auto">
                <button type="button" class="btn btn-primary" onclick="fnJobRequestProcStatSearch()">
