...
<div class="title-box">
    <h3 class="title02">점검 결과</h3>
</div>

<!-- 검색영역 -->
<div class="search-box">
    <form id="form_search_result" method="post" autocomplete="off">

        <input type="hidden" id="ColList" name="ColList" value=""/>

        <div class="row">
            <div class="col-md-6 col-lg-4 col-xxl-1">
            ...
            <div class="col-md-6 col-lg-4 col-xxl-2">
                <label class="form-label" for="chkAbnormalResult">이상점검결과</label>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="chkAbnormalResult">
            ...
            <div class="col col-md-auto">
                <button type="button" class="btn btn-primary" onclick="fnResultSearch()">
