...
<div class="result-header">
	<h2 class="result-header__title">상세정보<span class="result-header__count">(전체 <fmt:formatNumber value="${listCount}" type="number"/>건)</span></h2>
	...
	<div class="result-header__actions">
		<nav class="pagination" aria-label="페이지 이동">
			...
			<c:if test="${sessionScope.loginInfo.iui_isadmin ne '999'}">
				<button type="button" class="button button--secondary" onclick="reportExcelDownload5()">엑셀 다운로드</button>
			</c:if>
		</nav>
	</div>
</div>
