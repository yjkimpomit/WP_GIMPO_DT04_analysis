...
<section class="result-chart" aria-labelledby="cost-failure-chart-title">

	<div class="section-header visually-hidden">
		<h2 class="section-title" id="cost-failure-chart-title">정비비용 고장경향 분석 차트</h2>
	</div>
	
	<div class="chart-container">
		<canvas class="chart-placeholder" role="img" aria-label="정비비용 고장경향 분석 차트" id="trend_chart"></canvas>
	</div>
...
<!-- <div class="chart-area">
	<canvas id="trend_chart" class="chart-item" style="width: 100%; height: 320px;"></canvas>
</div> -->
