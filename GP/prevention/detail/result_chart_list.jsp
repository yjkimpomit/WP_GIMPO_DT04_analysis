    ...
    <div>
        ...
        <div class="btn-box">
            ...
            <c:if test="${sessionScope.loginInfo.iui_isadmin ne '999'}">
                <button type="button" class="btn btn-primary btn-file-download" onclick="reportExcelDownload4()">엑셀 다운로드</button>
            </c:if>
        </div>
    </div>
</div>
...
<script>
    ...
    function reportExcelDownload4() {
        ...
        $.ajax({
            type: "POST"
            , url: "/prevention/resultChartListexcelDownload.do"
            ...
            , success: function (response, status, xhr) {
                ...
                link.download = "점검결과(chart)_" + formattedDate + ".xlsx";
                link.click();  // 다운로드 트리거
